...
################################
    ...
    for t in tqdm(range(nt), desc="LCM timesteps", unit="step"):
        ...
        # Collisional Growth
        if do_collision:
            particles_list, acc_ts[t+1], aut_ts[t+1],precip_ts[t+1] = collection(dt, particles_list,rho_parcel, rho_liq, P_parcel, T_parcel, acc_ts[t+1], aut_ts[t+1],precip_ts[t+1], switch_sedi_removal, z_parcel, max_z, w_parcel, switch_E_constant, switch_vt_simple, switch_turb_kernel, epsilon_turb)
