...
class particles:
    def __init__(self,n):
        ...
        self.Ns     = 0.0
        self.SO4    = 0.0     # SO4 mass (g)
        self.NH4    = 0.0     # NH4 mass (g)
        
        #NO soot yet self.soot = 0.0 28.96 = molarmass of earth air
        self.so2    = 0.2E-9#/28.9644 # mole/g/air 
        self.o3     = 5.0E-8#/28.9644
        self.h2o2   = 0.5E-9#/28.9644
        self.nh3    = 0.1E-9#/28.9644
        self.hno3   = 0.1E-9#28.9644
        self.co2    = 360.0E-9#/28.9644
        self.H      = 1.0E-7 #/ 28.9644
        self.svi    = 0.0       
